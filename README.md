...
- [ ] **T3c 回放视角切换面板**："回放视角"下拉四选一，均用 alidarState.txt 位姿驱动、平滑插值消抖：①**第一人称**（车上 +1.2m 平视车头）；②**第三人称**（车后 12m 上 7m 注视车前，= 原跟随视角）；③**俯视跟随**（车正上方 45m 往下看、跟随位置、北向上）；④**上帝视角**（固定全局俯瞰不跟车，切换时立即 fit 全场景）。实测 company_wai12：first 相机-车 1.37m / third 15.8m / top 正上方 45m 水平偏移 1.7m / god 全程位移 0
